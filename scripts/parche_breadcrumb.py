...
old = """        og_img = f'<meta property="og:image" content="{DOMAIN}{p["og_image"]}">' if p['og_image'] else ''
        extra = f\"\"\"<meta property="og:title" content="{p['title']}">"""

new = """        og_img = f'<meta property="og:image" content="{DOMAIN}{p["og_image"]}">' if p['og_image'] else ''
